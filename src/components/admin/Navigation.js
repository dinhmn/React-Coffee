...
const Navigation = () => {
  return (
    <div className="w-[300px] h-auto bg-white shadow-md flex flex-col justify-start items-start px-5 py-3 gap-y-[6px] text-lg font-bold text-black">
      <NavItem url="/">
