...
const Category = ({ cate, deleteCategory, editCategory }) => {
  return (
    <tr className="bg-white" key={cate.id}>
      ...
      <td className="px-6 py-4 text-left whitespace-normal">
        <div className="text-sm text-gray-500">{cate.title}</div>
      </td>
      <td className="px-6 py-4 text-left whitespace-normal">
        <div className="text-sm text-gray-500">{cate.description}</div>
      </td>
      <td className="px-6 py-4 text-left whitespace-normal">
